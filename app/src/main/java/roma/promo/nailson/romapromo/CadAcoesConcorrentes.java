...
public class CadAcoesConcorrentes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cad_acoes_concorrentes);
        ActionBar act = getSupportActionBar();
        act.setDisplayHomeAsUpEnabled(true);
        act.setTitle("Cadastro de ações concorrentes");
        ...
        mDatabasepush = FirebaseDatabase.getInstance().getReference().child("FotosAcoesCorrentes");
    ...
    private void salvarOne() {
        ...
        startActivity(new Intent(CadAcoesConcorrentes.this, MainActivity.class));
        finish();
    }
    ...
    public void onBackPressed() {
        Intent telaAnuncio = new Intent(CadAcoesConcorrentes.this, MainActivity.class);
